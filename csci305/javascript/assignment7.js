...
//    box.position = new BABYLON.Vector3(5, 9, 10);
    ...
    sphere.material = new BABYLON.StandardMaterial("Ma1t", scene);
    sphere.material.diffuseTexture = new BABYLON.Texture("../textures/mcgphd.jpg", scene);
...
//     }
    ...
    var moveCamera = function() {
        camera.position = (new BABYLON.Vector3(10, 10, 2));

        //camera.reset();
        console.log("move camera activated");
    ...
    box3.actionManager = new BABYLON.ActionManager(scene);
    var action2 = new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, moveCamera);
    box3.actionManager.registerAction(action2);
    ...
    //when the user click is true then a message appears
